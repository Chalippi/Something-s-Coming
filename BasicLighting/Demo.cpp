...
{
	xpos += deltaTime * 0.0003f;

	if (xpos > 3) xpos = 0;

	mat4 transform;
	transform = translate(transform, vec3(xpos - 1.5f, -0.65f, 0.0f));
...
int main(int argc, char** argv) {
	...
	game.Start("Draw Sprite Based Animation", 800, 600, true, WindowFlag::WINDOWED, 0, 1);
